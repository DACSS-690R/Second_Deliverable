...
```{r}
linkClerkshipGrades_clean='https://github.com/DACSS-690R/Second_Deliverable/raw/refs/heads/main/DataCleanAndFormatted/SMMH_clean.csv'
SMMH_clean=read.csv(linkSMMH_clean)
str(SMMH_clean)
